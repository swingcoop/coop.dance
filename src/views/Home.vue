      ...
      <div class="swing">
         <div class="column">
            ...
            <section class="post-title-section">
               <h2>November 16-17</h2>

               <div style="text-align: center">
                  <img 
                     src="../assets/fall-swingout-plain.jpg" 
                     width="95%" 
                     style="margin-top: 1rem; border: solid 3px #eee" />
               </div>
               
               <p>The Olympia Fall Swingout is our premier dance event of the season.</p>

               <p>
                  Featuring world-renowned instructors Joshua Mclean and Ana Lisa Sutherland,
                  our fall workshop weekend is seven dance classes and an evening swing 
               ...
               <div style="text-align: center">
                  <img 
                     src="../assets/josh-ana-lisa-balance.jpg" 
                     width="95%" 
                     style="margin-top: 1rem; border: solid 3px #eee" />
               </div>
               ...
               <p>
                  ...
                  sounds of the 1920s, 30s and 40s. Joshua and Ana Lisa will be the featured 
               ...
               <p>
                  Day two of the Olympia Fall Swingout will feature a series of solo jazz classes 
                  with Joshua and Ana Lisa at the Olympia Eagles' Doc Becker room, which is
            ...
            <section class="post-title-section">
               <h2>More Swing Dance Lessons</h2>
               <noscript>
